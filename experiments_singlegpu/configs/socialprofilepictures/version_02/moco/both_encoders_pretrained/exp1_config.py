...
model = "resnet18"
model_path = "/scratch/work/Tesi/LucaPiano/spice/results/socialprofilepictures/version_02/moco/both_encoders_pretrained/exp1/checkpoints/checkpoint_last.pth.tar"
