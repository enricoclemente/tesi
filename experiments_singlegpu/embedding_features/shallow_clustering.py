...
parser = argparse.ArgumentParser(description='Shallow clustering')
parser.add_argument('--resources_folder', metavar='DIR', default='./results/cifar10/moco',
                    help='path where features and tsne are saved')
